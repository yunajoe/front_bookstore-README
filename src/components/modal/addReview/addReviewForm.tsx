...
function AddReviewForm() {
  const { control, handleSubmit, isButtonActive,newRating, setNewRating, handleAddReview } = useAddReview();

  return (
    <>
      <form className="flex flex-col w-full gap-40 overflow-scroll" onSubmit={handleSubmit(handleAddReview)}>
        <TitleContentTable
          title1="책 제목"
      ...
      <RegisterButton type='submit' disabled={isButtonActive ? true : false} >리뷰 작성하기</RegisterButton>
    </>
  );
}
