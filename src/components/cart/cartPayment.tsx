...
function CartPayment({ totalAmount, totalDiscount, bookTotalCount }: CartPaymentProps) {
  ...
  return (
    <div
      className="mobile:w-full h-fit flex flex-col w-340 tablet:w-216 border-2 border-solid
        border-gray-1 mt-94 mobile:mt-20 p-30 tablet:p-20 mobile:p-20 rounded-[10px]">
