        ...
        <div className="w-full flex">
          ...
          <label htmlFor="loginSaved " className="flex-center">
            <div
              ...
              className={`flex-center ${isClick ? 'bg-slate-300' : ''} rounded-full w-5 h-5 border-solid border-2  border-[#DBDBDB] cursor-pointer`}>
              {isClick && (
                <Image
                  alt=""
          ...
          <p className="mx-2 font-15 text-[#363636]">로그인 상태 유지</p>
        </div>
