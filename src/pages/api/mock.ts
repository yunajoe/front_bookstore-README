...
export const ReadMeForeignCategoryList: CategoryList = {
  categoryList: [
    ...
    createForeignCategory('예술/대중문화', '/'),
    createForeignCategory('요리', '/'),
    createForeignCategory('의학', '/'),
    createForeignCategory('인문/사회', '/'),
    createForeignCategory('자기계발', '/'),
    createForeignCategory('과학/수학/생태', '/'),
    createForeignCategory('전기/자서전', '/'),
    createForeignCategory('종교/명상/점술', '/'),
    createForeignCategory('청소년', '/'),
    createForeignCategory('컴퓨터', '/'),
    createForeignCategory('해외잡지', '/'),
    createForeignCategory('ELT/어학/사전', '/'),
    createForeignCategory('일본도서', '/'),
    createForeignCategory('중국도서', '/'),
    createForeignCategory('독일도서', '/'),
    createForeignCategory('스페인도서', '/'),
    createForeignCategory('한국관련도서', '/'),
  ],
};

export const ReadMeCategoryList: CategoryList = {
  categoryList: [
